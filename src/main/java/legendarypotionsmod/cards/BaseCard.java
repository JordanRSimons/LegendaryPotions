package legendarypotionsmod.cards;
...
import static legendarypotionsmod.util.GeneralUtils.removePrefix;
import static legendarypotionsmod.util.TextureLoader.getCardTextureString;
