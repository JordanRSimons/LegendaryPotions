...
public class OrangeBeastStatue extends BaseRelic {
    private static final String NAME = "OrangeBeastStatue"; //The name will be used for determining the image file as well as the ID.
